...
class AgentCreateView(LoginOrganiserRequiredMixin, generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        user.is_agent = True
        user.set_password(f"{random.randint(100000000000000000000000,100000000000000000000000000)}")
        user.save()
...
class AgentUpdateView(LoginOrganiserRequiredMixin, generic.UpdateView):
    ...
    def get_object(self):
        instance = super(AgentUpdateView, self).get_object(queryset=self.get_queryset())
